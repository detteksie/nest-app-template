...
$ docker container exec -it <workdir_name_server>
...
# docker container exec -it nestapp sh
$ npm run migration:run # for migration (npm run migration:revert -> for reverting)
```
